...
$6/bin/igblastn -germline_db_V database/imgt_human_TRV_igblast -germline_db_J database/imgt_human_TRJ_igblast -germline_db_D database/imgt_human_TRD_igblast -organism human -query $5/$2_quality-pass.fasta  -ig_seqtype TCR -auxiliary_data optional_file/human_gl.aux -show_translation -outfmt 19  > $5/$2_after_annotation.tsv 
...
Rscript /home/mor/TCR_pipeline/Assign_into_Clones_[T_CELL].R $5/$2_after_annotation.tsv $2 $5 > $5/Assign_into_Clones_log.txt
